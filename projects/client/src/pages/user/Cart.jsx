    ...
    <VStack spacing={4} align="stretch">
      {isLoading ? (
        ...
        <Box flex="1" p="4">
          <Heading as="h2" size="md" mb="2">
            You have an unpaid transaction, cancel or pay first to continue
            shopping
          </Heading>
      ...
      {cartData.length > 0 && !unpaidTransaction && (
        <>
          ...
          <Button colorScheme="teal" onClick={onOpen} width={"300px"}>
            Reset Cart
          </Button>
        </>
      )}
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalCloseButton />
          <ModalBody>Are you sure you want to reset your cart?</ModalBody>
          <ModalFooter>
